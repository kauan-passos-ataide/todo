...
const NameModal = ({ show, onClose, onSubmit }: 
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen bg-black bg-opacity-50 z-50 flex items-center justify-center select-none">
      <div className="border-2 border-gray-300 bg-black/70 w-11/12 lg:w-2/3 h-2/6 p-10 rounded-lg z-60 flex flex-col relative justify-between overflow-x-hidden overflow-y-auto">
        <div className='mt-6'>
