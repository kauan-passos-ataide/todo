...
const SubModal = ({ show, onClose, onSubmit }: 
    ...
    <div className="fixed inset-0 w-screen h-screen z-50 flex items-center justify-center select-none">
      <div className="bg-gray-100 w-11/12 lg:w-2/3 h-4/5 p-10 rounded-lg z-60 block items-center justify-center overflow-x-hidden overflow-y-auto">
        <div className='flex flex-row gap-5'>
          ...
          <button onClick={handleSubmit} className="px-14 py-2 bg-gradient-zinc bg-[length:200%_200%] animate-gradient-move text-white rounded flex justify-center items-center hover:bg-zinc-900">
            Salvar
          </button>
        </div>
        <div>
          ...
          <div className='bg-gradient-white bg-[length:200%_200%] animate-gradient-move p-[1px] rounded-md'>
            ...
            placeholder='Digite o título da sub tarefa'
            value={inputValue}
